...
export function ModelBreakdownCard({ breakdown }: ModelBreakdownCardProps) {
  if (!breakdown || breakdown.length === 0) {
    return (
      <div className="border border-[var(--sand-200)] rounded-xl bg-[var(--sand-50)] p-6 mb-6">
  ...
  return (
    <div className="border border-[var(--sand-200)] rounded-xl bg-[var(--sand-50)] mb-6">
      <div className="px-4 py-3 border-b border-[var(--sand-200)]">
