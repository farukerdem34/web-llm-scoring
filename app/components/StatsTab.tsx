    ...
    <div>
      ...
      <div className="flex flex-wrap items-end gap-3 mb-6">
        <div>
          ...
          <select
            ...
            className="border border-[var(--sand-200)] rounded-lg px-3 py-1.5 text-sm text-[var(--ink)] bg-[var(--sand-50)] dark:bg-[var(--sand-100)] focus:outline-none focus:ring-2 focus:ring-[var(--terracotta)]/30"
          >
      ...
      {data && !loading && (
        <>
          ...
          {/* Records table */}
          <div className="border border-[var(--sand-200)] rounded-xl bg-[var(--sand-50)]">
            <div className="px-4 py-3 border-b border-[var(--sand-200)] rounded-t-xl">
